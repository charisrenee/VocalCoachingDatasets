...
| Sing-MD | 2025 | expert singing assessment | 1,000 clips | expert 4-dim scores: breath control; timbre quality; emotional expression; vocal technique | open | https://huggingface.co/karl-wang/QwenFeat-Vocal-Score | also referred to as VocalVerse; recommended and now linked to the released Hugging Face dataset |
| PopBuTFy | 2022 | amateur vs professional singing comparison | multiple songs, paired recordings | parallel amateur/professional recordings of the same songs | open | https://github.com/MoonInTheRiver/NeuralSVB | recommended paired-performance dataset from the shortlist; linked via the NeuralSVB repository |
...
| Sing-MD | 2025 | expert singing assessment | 1,000 clips | expert 4-dim scores: breath control; timbre quality; emotional expression; vocal technique | audio; 4-dim expert scores; text critiques | Zhejiang University authors | Mandarin | open | HF dataset terms | https://huggingface.co/karl-wang/QwenFeat-Vocal-Score | https://huggingface.co/karl-wang/QwenFeat-Vocal-Score | also referred to as VocalVerse; recommended and now linked to the released Hugging Face dataset |
| PopBuTFy | 2022 | amateur vs professional singing comparison | multiple songs, paired recordings | parallel amateur/professional recordings of the same songs | paired amateur/professional recordings | NeuralSVB authors | not specified | open | GitHub repo terms | https://github.com/MoonInTheRiver/NeuralSVB | https://github.com/MoonInTheRiver/NeuralSVB | recommended paired-performance dataset from the shortlist; linked via the NeuralSVB repository |
